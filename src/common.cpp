...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    ...
    {3, RATE_125HZ, SX1280_LORA_BW_0800, SX1280_LORA_SF7, SX1280_LORA_CR_LI_4_7, 7000,  TLM_RATIO_1_32,      4,          12}, // ?
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {1, RATE_500HZ, -105, 1586, 1000,               1000,                       100,                       2000},
    {2, RATE_250HZ, -108, 3330, 1000,               1000,                       100,                       4000},
    {3, RATE_125HZ, -112, 6187, 1000,               4000,                       100,                       4000},   // todo, see if the large RFmodeCycleAddtionalTime can be reduced
